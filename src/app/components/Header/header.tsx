    ...
    <HeaderItems.TagHeader>
      <HeaderItems.ContentHeader>
        ...
        <HeaderItems.CarrinhoButton title="Botão de compras">
            <MarketCar aria-label="Imagem de carrinho de supermercado"/>
            <HeaderItems.NumeroDeItensDoCarrinho>0</HeaderItems.NumeroDeItensDoCarrinho>
        </HeaderItems.CarrinhoButton>
      </HeaderItems.ContentHeader>
    </HeaderItems.TagHeader>
  )
}